# SHEEPERING
> Source : GitHub (`Sources/Github/Sheepering.md`) — v1.2 — Prototype en cours de conception
...
Le chemin n'est pas uniquement composé de prairies : certaines tuiles chemin traversent des terrains particuliers.
